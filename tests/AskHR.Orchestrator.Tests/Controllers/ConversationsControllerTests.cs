...
using AskHR.Common.Dtos.Conversations;
...
public class ConversationsControllerTests
{
    ...
    private Moq.Mock<AskHR.Orchestrator.Services.AnonymousSessions.IAnonymousSessionService> _mockAnonymousSessionService;
    private Moq.Mock<AskHR.Orchestrator.Services.AnonymousSessions.IIpAddressService> _mockIpAddressService;
    ...
    public void Setup()
    {
        ...
        _mockAnonymousSessionService = new Moq.Mock<AskHR.Orchestrator.Services.AnonymousSessions.IAnonymousSessionService>();
        _mockIpAddressService = new Moq.Mock<AskHR.Orchestrator.Services.AnonymousSessions.IIpAddressService>();
