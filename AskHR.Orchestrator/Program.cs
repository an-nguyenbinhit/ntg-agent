...
builder.Services.AddScoped<IReingestTool, ReingestTool>();
...
builder.Services.AddScoped<IAskHrStreamService, AskHrStreamService>();
builder.Services.AddScoped<ISeverityClassifier, RuleBasedSeverityClassifier>();
builder.Services.AddScoped<IWarmHandoffService, WarmHandoffService>();
builder.Services.AddScoped<IAuditTextProtector, AuditTextProtector>();
builder.Services.AddSingleton<QueuedDatabaseAuditEventSink>();
builder.Services.AddSingleton<IAuditEventSink>(serviceProvider => serviceProvider.GetRequiredService<QueuedDatabaseAuditEventSink>());
builder.Services.AddHostedService(serviceProvider => serviceProvider.GetRequiredService<QueuedDatabaseAuditEventSink>());
builder.Services.AddHostedService<AskHR.Orchestrator.Services.AnonymousSessions.AnonymousSessionCleanupService>();
builder.Services.AddScoped<IIdentityResolver, WebIdentityResolver>();
