...
window.getTheme = function () {
    return localStorage.getItem('askhr-theme') || 'light';
};
...
window.setAccentColor = function (accent) {
    localStorage.setItem('askhr-accent', accent);
    if (accent === 'default') {
...
window.getAccentColor = function () {
    return localStorage.getItem('askhr-accent') || 'default';
};
...
window.clearAppStorage = function () {
    localStorage.removeItem('askhr-theme');
    localStorage.removeItem('askhr-accent');
