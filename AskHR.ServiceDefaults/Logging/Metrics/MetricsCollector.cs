...
namespace AskHR.ServiceDefaults.Logging.Metrics;

public class MetricsCollector(ILogger<MetricsCollector> logger, string meterName = "AskHR") : IMetricsCollector, IDisposable
{
